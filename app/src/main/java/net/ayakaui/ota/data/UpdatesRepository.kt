...
import net.ayakaui.ota.data.source.network.NetworkUpdate
import net.ayakaui.ota.data.source.network.UpdatesNetworkDataSource
import net.ayakaui.ota.data.source.network.parsePackageFileRanges
import net.ayakaui.ota.data.source.network.toIncrementalUpdate
import net.ayakaui.ota.data.source.network.toUpdate
import net.ayakaui.ota.deviceinfo.DeviceInfoUtils
import net.ayakaui.ota.download.SingleRangeHttpFetcher
