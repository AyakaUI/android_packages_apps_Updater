 ...
 */
package net.ayakaui.ota.controller;
...
import net.ayakaui.ota.UpdaterReceiver;
import net.ayakaui.ota.UpdatesActivity;
import net.ayakaui.ota.misc.Constants;
import net.ayakaui.ota.misc.StringGenerator;
