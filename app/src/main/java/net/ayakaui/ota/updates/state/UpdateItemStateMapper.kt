...
package net.ayakaui.ota.updates.state
...
import net.ayakaui.ota.updates.action.UpdateAction
import net.ayakaui.ota.updates.action.UpdateActionType
import net.ayakaui.ota.updates.action.UpdateActions
import net.ayakaui.ota.util.InstallUtils
import net.ayakaui.ota.util.NetworkMonitor.NetworkState
