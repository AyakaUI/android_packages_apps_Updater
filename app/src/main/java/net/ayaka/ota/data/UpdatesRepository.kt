...
import net.ayaka.ota.data.source.network.NetworkUpdate
import net.ayaka.ota.data.source.network.UpdatesNetworkDataSource
import net.ayaka.ota.data.source.network.parsePackageFileRanges
import net.ayaka.ota.data.source.network.toIncrementalUpdate
import net.ayaka.ota.data.source.network.toUpdate
import net.ayaka.ota.deviceinfo.DeviceInfoUtils
import net.ayaka.ota.download.SingleRangeHttpFetcher
import net.ayaka.ota.misc.Constants
