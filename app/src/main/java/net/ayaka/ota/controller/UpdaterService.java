 ...
 */
package net.ayaka.ota.controller;
...
import net.ayaka.ota.UpdaterApplication;
import net.ayaka.ota.UpdaterReceiver;
import net.ayaka.ota.UpdatesActivity;
